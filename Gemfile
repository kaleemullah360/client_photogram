...
group :development, :test do
  #gem file to convert erb to haml
  gem 'erb2haml'
  ...
  gem 'haml-rails', '~> 0.9.0'  #added by kaleem for processing haml
  gem 'paperclip', '~> 4.3.1'   #added by kaleem for processing file
  gem 'simple_form', '~> 3.1.0' # to do simple html form
